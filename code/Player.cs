...
partial class AirCannonPlayer : Player
{
	...
	{
		//BecomeRagdollOnClient( Vector3.Zero, DamageFlags.Blast, position, force, 0 );
	}
	...
	public override void Simulate( Client cl )
	{
		...
		if ( IsServer && Input.Pressed( InputButton.Slot1 ) )
		{
			...
			TraceResult tr = Trace.Ray( EyePosition, EyeRotation.Forward )
				.Ignore( this )
				.Run();

			testProp.Position = tr.EndPosition;
